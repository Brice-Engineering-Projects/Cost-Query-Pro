...
Revision ID: 7ab4415b0666
Revises: 1f94dedb7b5c
Create Date: 2025-07-21 00:22:04.193503
...
revision: str = '7ab4415b0666'
down_revision: Union[str, Sequence[str], None] = '1f94dedb7b5c'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_items_item_description'), 'items', ['item_description'], unique=False)
