...
class ProjectBase(BaseModel):
    ...
    """
    project_name: str = Field(..., min_length=1, max_length=255, example="Main St. Sewer Rehab")
...
class ProjectUpdate(BaseModel):
    ...
    """
    project_name: Optional[str] = Field(None, min_length=1, max_length=255, example="Main St. Sewer Rehab")
    project_number: Optional[str] = Field(None, min_length=1, max_length=50, example="202301")
